...
namespace BankPortalAPI.Controllers
{
    public class AuthController : Controller
    {
        ...
        public AuthController(IAuthService authService, SqlConnection sqlConnection, IConfiguration configuration ,ICommonServices commonServices)
        {
        ...
        [HttpPost("login_PS")]
        public async Task<IActionResult> Login_PS([FromBody] jsonEncryptModel jsonEncrypt)   //UserModel userModel
        {
            var keyString = _configuration["EncryptionKey"];
            var responseObject = new ResponseObject();
        ...
        public async Task<IActionResult> LoginRegistration_PS([FromBody] jsonEncryptModel jsonEncrypt)   //jsonEncryptModel jsonEncrypt   UserLoginModel userLogin
        {
            var responseObject = new ResponseObject();
            try
            {
